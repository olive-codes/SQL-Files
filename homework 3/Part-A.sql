...
ORDER BY Lname ASC;
--2
SELECT D.Dnumber, D.Dname, AVG(E.Salary) as avgSalary FROM Employee E, Department D 
WHERE E.Dno = D.Dnumber 
GROUP BY D.Dnumber, D.Dname 
ORDER BY D.Dnumber ASC;
--3 -> Manager not just employee
SELECT DISTINCT E.Lname FROM Employee E 
...
--5 maybe
SELECT D.Dname, COUNT(E.Ssn) as NUMEMP, COUNT(DEP.Dependent_name) AS NUMDEP FROM Department D
INNER JOIN Employee E ON E.Dno = D.Dnumber  
INNER JOIN Dependent DEP on E.Ssn = DEP.Essn 
GROUP BY Dname;

--6 Employee has sex and salary
SELECT E.Sex, SUM (Salary) AS TotalPay FROM Employee E
GROUP BY E.Sex;
    
--7
SELECT E.Fname, E.Lname FROM Employee E 
WHERE E.Salary >= (SELECT MAX(Salary) FROM Employee) - 20000 
ORDER BY Lname ASC; 

--8 use dlocation and plocation aka dept_locations and project
SELECT E.Fname, E.Lname, E.Address FROM Employee E
INNER JOIN dept_locations D ON D.Dnumber = E.Dno
INNER JOIN project P ON P.Dnum = E.Dno
WHERE D.Dlocation <> 'Houston' AND P.Plocation = 'Houston';
